...
GLIBMM_DLL = $(OUTDIR)\$(GLIBMM_DLLNAME).dll
GLIBMM_LIB = $(OUTDIR)\$(GLIBMM_LIBNAME).lib
GIOMM_DLL = $(OUTDIR)\$(GIOMM_DLLNAME).dll
GIOMM_LIB = $(OUTDIR)\$(GIOMM_LIBNAME).lib
GLIBMM_EXTRA_DEFS_GEN_DLL = $(OUTDIR)\$(GLIBMM_EXTRA_DEFS_GEN_DLLNAME).dll
GLIBMM_EXTRA_DEFS_GEN_LIB = $(OUTDIR)\$(GLIBMM_EXTRA_DEFS_GEN_LIBNAME).lib
